          ...
          <header className="no-print mb-8 flex flex-col gap-5 border-b border-white/10 pb-6 sm:mb-10 sm:pb-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <nav className="flex snap-x snap-mandatory gap-2 overflow-x-auto pb-1 [-webkit-overflow-scrolling:touch] sm:flex-wrap sm:overflow-visible lg:max-w-none">
              <Link
                ...
                className="snap-start shrink-0 touch-manipulation rounded-xl border border-rose-500/35 bg-rose-600/15 px-4 py-3 text-center text-sm font-semibold text-rose-100 transition active:scale-[0.98] sm:py-2.5"
              >
                Recaudación
              </Link>
              <Link
